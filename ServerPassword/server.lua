...
--- CONFIG ---
password = "FLRP" -- Set server password here
kickMessage = "Mauvais mot de passe" -- The invalid password kick message. Default: Invalid Password
...
invalidPasswordTimeout = 3 * 60 -- Wait time before the player can re-join. Change the first value Not the '* 60'. Default: 5 minutes
